                ...
                >
                  <span className="mr-3">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <path d="M22.675 0h-21.35C.673 0 0 .673 0 1.325v21.35C0 23.327.673 24 1.325 24h21.35C23.327 24 24 23.327 24 22.675V1.325C24 .673 23.327 0 22.675 0zm-3.212 12.288h-3.24v9.408h-4.038v-9.408h-2.11v-3.485h2.11v-2.06c0-2.38 1.292-3.68 3.354-3.68.975 0 2.062.174 2.062.174v2.273h-1.165c-1.143 0-1.496.711-1.496 1.437v1.694h3.079l-.497 3.485z" />
                    </svg>
                  </span>
