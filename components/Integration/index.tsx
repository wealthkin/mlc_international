        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              subtitle: `Stay Connected with God, Anytime, Anywhere.`,
              description: `Grow in your faith wherever you are. Access prayer resources, daily devotionals, and community support.`,
            }}
          />
          {/* <!-- Section Title End --> */}
        </div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/community.svg"
                  alt="Community"
                />
              </div>
            </motion.div>
