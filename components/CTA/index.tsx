          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Join Us in Faith & Grow Closer to God
              </h2>
              <p>
                Strengthen your walk with Christ by becoming part of our spiritual family. Together, we can grow in faith, serve others, and spread the Gospel.
              </p>
            </motion.div>
            <motion.div
              variants={{
